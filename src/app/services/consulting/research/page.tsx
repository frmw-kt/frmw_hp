    ...
    <>
      ...
      <section className="relative bg-slate-950 text-white overflow-hidden py-32 md:py-44">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <p className="text-blue-400 text-xs font-semibold tracking-[0.2em] uppercase mb-5">Research & Analysis</p>
          <h1 className="text-4xl md:text-6xl font-black leading-tight tracking-tight mb-6 max-w-3xl">
            データから、<br />
            <span className="gradient-text">戦略の土台を築く。</span>
          </h1>
      ...
      <section className="py-24 bg-slate-100">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-5 tracking-tight">調査分析のご相談はお気軽に</h2>
