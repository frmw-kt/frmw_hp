    ...
    <>
      <section className="relative bg-[#0a0a0a] text-white overflow-hidden py-32 md:py-44">
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <p className="text-white/40 text-xs tracking-[0.3em] uppercase mb-5">Marketing Strategy</p>
      ...
      <section className="py-24 bg-[#fafafa] border-t border-[#e5e5e5]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-[#0a0a0a] mb-5 tracking-tight">戦略立案のご相談はお気軽に</h2>
          <p className="text-[#737373] mb-10 leading-relaxed">現在の戦略の課題感や目標をお聞かせください。初回相談は無料です。</p>
